...
angular.module('ts5App')
  .controller('RefundCompanyReasonCodeCtrl', function ($scope,$compile,ENV,$resource,$location,$anchorScroll,itemsFactory,companiesFactory,currencyFactory,$routeParams,GlobalMenuService) {
