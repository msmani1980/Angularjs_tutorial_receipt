...
angular.module('ts5App')
  .controller('ItemImportCtrl', function ($scope, $q, ItemImportFactory) {
    ...
    (function contructor() {
      ...
      ItemImportFactory.getCompaniesList({
        companyTypeId: 2,
        limit: null
      }).then(function (response) {
        $scope.stockOwnerList = response.companies;
        // TODO - Can only mock until https://jira.egate-solutions.com/browse/TSVPORTAL-2038 is done
        var mockResponse = {
          'companies': [{
            'id': 419,
            'companyName': 'TEST_009',
            ...
            'id': 404,
            'companyName': 'StockOwner1',
            'companyTypeName': 'Stockowner',
            'companyTypeId': 2,
            'parentCompanyId': null,
            'legalName': 'StockOwner1',
            'ediName': null,
            'dbaName': null,
            'countRelation': '0',
            'baseCurrencyCode': 'USD',
            ...
            'id': 396,
            'companyName': 'stockCom12',
            'companyTypeName': 'Stockowner',
            'companyTypeId': 2,
            'parentCompanyId': null,
            'legalName': 'stockCom12',
            'ediName': 'stockCom1',
            'dbaName': 'stockCom12',
            'countRelation': '0',
            'baseCurrencyCode': 'USD',
            ...
            'dbaName': null,
            'countRelation': '0',
            'baseCurrencyCode': 'TTS',
            'companyCode': 'dsf',
            'isActive': 'false',
            'baseCurrencyId': 13,
            'companyLanguages': 'French (Standard)',
            'exchangeRateVariance': null
          }],
          'meta': {
            'count': 8,
        ...
        $scope.stockOwnerList = mockResponse.companies;
      });
