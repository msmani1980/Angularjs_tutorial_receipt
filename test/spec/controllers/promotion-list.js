...
describe('Controller: PromotionListCtrl', function() {
  ...
  var recordsService;
  var getPromotionListDeferred;
  var getBenefitTypeListDeferred;
  var getPromotionTypeListDeferred;
  var promotionListJSON;
  var benefitTypeListJSON;
  var promotionTypeListJSON;
  ...
  it('setBenefitTypeList should set retail item list', function() {
    ...
    expect(scope.benefitTypeList).toEqual([{
      id: 1
    }]);
  });
  ...
  it('setPromotionTypeList should set retail item list', function() {
    ...
    expect(scope.promotionTypeList).toEqual([{
      id: 1
    }]);
  });
});
