...
describe('itemListCtrl', function () {
  ...
  describe('The itemsList array', function () {
    ...
    describe('nest versions function', function () {
      beforeEach(function () {
        scope.itemsList = angular.copy([{
          itemMasterId: 36,
          startDate: '1800-09-15',
          endDate: '1820-12-15'
        }, {
          itemMasterId: 36,
          ...
          itemMasterId: 36,
          startDate: '2040-09-15',
          endDate: '2045-12-15'
        }, {
          itemMasterId: 36,
          startDate: '2035-07-15',
          endDate: '2036-07-25'
        }, {
          itemMasterId: 36,
  ...
  describe('versions accordion', function () {
    ...
    describe('doesActiveOrFutureVersionExist', function () {
      ...
      it('should return true for items that contain an active version', function () {
        var testItem = {
          versions: [{
            startDate: '08/20/2010',
            endDate: '08/20/2030'
          }, {
            startDate: '08/20/2005',
            endDate: '08/10/2010'
          }, {
            startDate: '08/20/1980',
            endDate: '01/01/1991'
          }]
        };
        expect(scope.doesActiveOrFutureVersionExist(testItem)).toEqual(true);
